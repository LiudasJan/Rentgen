...
// Override userData path for E2E tests - must be done before app.ready
if (process.env.RENTGEN_USER_DATA_PATH) {
  app.setPath('userData', process.env.RENTGEN_USER_DATA_PATH);
}
