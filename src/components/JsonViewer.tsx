...
import { useContextMenu, ResponsePanelContext } from './context-menu';
...
export function JsonViewer({ source, className, responsePanelContext }: Props) {
  ...
  const responsePanelContextRef = useRef(responsePanelContext);
  ...
  const handleEditorDidMount: OnMount = (editor, monacoInstance) => {
    ...
    editor.onContextMenu((e) => {
      ...
      showContextMenuRef.current?.(browserEvent.clientX, browserEvent.clientY, selectedText, contextWithPath);
    });
  };
