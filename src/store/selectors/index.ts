...
export const selectHistoryEnabled = (state: RootState) => state.settings.general.historyEnabled;
export const selectHistorySize = (state: RootState) => state.settings.general.historySize;
export const selectHistoryRetention = (state: RootState) => state.settings.general.historyRetention;
